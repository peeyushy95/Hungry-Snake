...
def about():
    Img1 = pygame.image.load('snake.png')
    Img2 = pygame.image.load('Creator.jpg')
    DISPLAY.fill(BLACK)        
    ...
    printString('Linkdin          :   www.linkedin.com/in/peeyushy95',25,452)
    printString('Email            :   peeyushy95@gmail.com ',25,426)
    printString('Facebook         :   www.facebook.com/peeyushy95',25,478)
    pygame.display.update()
